<template>
  <div class="privacy">
    ...
    <p>
      ...
      персональных данных, предпринимаемые ИП Полоса Д.Г. (далее – Оператор).
    </p>
    ...
    <p>
      ...
      может получить о посетителях веб-сайта https://r15shinomontazh.ru.
    </p>
    ...
    <p>
      ...
      интернет по сетевому адресу https://r15shinomontazh.ru.
    </p>
    ...
    <p>
      5.7. Обработка персональных данных, разрешенных для распространения, из
    ...
    <p>
      5.8. Согласие Пользователя на обработку персональных данных, разрешенных
    ...
    <p>
      ...
      новых продуктах и услугах, специальных предложениях и различных событиях.
      ...
      sinritm@gmail.com с пометкой «Отказ от уведомлений о новых продуктах и
    ...
    <p>
      ...
      являются: – договоры, заключаемые между оператором и субъектом
    ...
    <p>
      ...
      специальные формы, расположенные на сайте https://r15shinomontazh.ru или
    ...
    <p>
      ...
      уведомления на адрес электронной почты Оператора sinritm@gmail.com с
    ...
    <p>
      ...
      электронный адрес Оператора sinritm@gmail.com с пометкой «Отзыв согласия
    ...
    <p>
      ...
      Оператору с помощью электронной почты sinritm@gmail.com.
    </p>
    ...
    <p>
      ...
      Интернет по адресу
      <a href="https://r15shinomontazh.ru/privacy/" target="_blank"
        >https://r15shinomontazh.ru/privacy/</a
      >.
    </p>
  </div>
</template>
